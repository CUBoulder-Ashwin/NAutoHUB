...
# Load trained model
generic_model = tf.keras.models.load_model(os.path.join(models_dir, 'generic_show_command_model.h5'))
...
def predict_generic_show_command(intent_only):
    ...
    predicted_command = generic_label_encoder.inverse_transform([prediction.argmax()])[0]
